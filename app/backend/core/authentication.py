...
class AuthenticationHelper:
    ...
    def build_security_filters(self, overrides: Overrides, auth_claims: dict[str, Any]):
        ...
        use_oid_security_filter = self.require_access_control or overrides.use_oid_security_filter
        use_groups_security_filter = self.require_access_control or overrides.use_groups_security_filter
    ...
    async def check_path_auth(self, path: str, auth_claims: dict[str, Any], search_client: SearchClient) -> bool:
        ...
        security_filter = self.build_security_filters(overrides=Overrides(), auth_claims=auth_claims)
